 ...
 */
    ...
    public MethodSecurityExpressionHandler defaultMethodSecurityExpressionHandler() {
        ...
        //DemoAclPermissionEvaluator permissionEvaluator = new DemoAclPermissionEvaluator(aclService());
        expressionHandler.setPermissionEvaluator(permissionEvaluator);
        expressionHandler.setPermissionCacheOptimizer(new CustomAclPermissionCacheOptimizer(aclService()));
    ...
    @Bean
    public CustomMutableAclService aclService() {
        //return new JdbcMutableAclService(dataSource, lookupStrategy(), aclCache());
        return new CustomMutableAclService(dataSource, lookupStrategy(), aclCache());
    }
